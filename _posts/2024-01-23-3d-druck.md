...
Das originale Anycubic Druckbett lässt sich recht leicht in OrcSlicer darzustellen.
...
Dort unter Model das Model von Acubic auswöhlen. Im Fall des Anycubic Kobra 2 Neo ist es das 220x220  Druckbett. Die STL-Datei `220.stl` ist bei mir dann z.B. unter `C:\Program Files\AnycubicSlicer\resources\profiles\Anycubic` zu finden. 
